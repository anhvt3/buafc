const DATA_VERSION = "buafc-2026-07-16-v5";
...
const INITIAL_MATCHES = [
  ...
  { date: "2026-03-03", opponent: "Nội bộ", result: "Thua", cost: 0, note: "", losingTeam: ["Phạm Tiến Hùng", "Vũ Thế Anh"], playedTeam: ["Phạm Tiến Hùng", "Vũ Thế Anh", "Đoàn Thế Anh", "Nguyễn Quang Tuyên", "Trịnh Minh Châm", "Hùng Chu", "Nguyễn Viết Hòa", "Trần Việt Hưng", "Trần Văn Tuấn", "Nguyễn Ngọc Quý", "Phú Hà", "Thai Nguyen"] },
  { date: "2026-03-17", opponent: "Nội bộ", result: "Hòa", cost: 0, note: "Hòa 4-4", losingTeam: [], playedTeam: ["Vũ Thế Anh", "Phú Hà", "Đoàn Thế Anh", "Nguyễn Quang Tuyên", "Trịnh Minh Châm", "Hùng Chu", "Nguyễn Viết Hòa", "Trần Việt Hưng", "Trần Văn Tuấn", "Nguyễn Ngọc Quý", "Duy Phạm", "Phạm Tiến Hùng", "Vũ Văn An", "Ho Trong Thuan"] },
  { date: "2026-03-24", opponent: "Nội bộ", result: "Thua", cost: 0, note: "", losingTeam: ["Phú Hà", "Trịnh Minh Châm", "Đoàn Thế Anh", "Hùng Chu", "Nguyễn Quang Tuyên", "Duy Phạm", "Trần Văn Tuấn", "Trần Nhật Thăng"], playedTeam: ["Phú Hà", "Trịnh Minh Châm", "Đoàn Thế Anh", "Hùng Chu", "Nguyễn Quang Tuyên", "Duy Phạm", "Trần Văn Tuấn", "Trần Nhật Thăng", "Vũ Thế Anh", "Phạm Tiến Hùng", "Nguyễn Ngọc Quý", "Thai Nguyen", "Vũ Văn An", "Trần Đức", "Nguyễn Viết Hòa", "Trần Việt Hưng", "Ho Trong Thuan"] },
  { date: "2026-03-31", opponent: "Nội bộ", result: "Thua", cost: 0, note: "", losingTeam: ["Ho Trong Thuan", "Trịnh Minh Châm"], playedTeam: ["Ho Trong Thuan", "Trịnh Minh Châm", "Vũ Thế Anh", "Phú Hà", "Đoàn Thế Anh", "Nguyễn Quang Tuyên", "Hùng Chu", "Nguyễn Viết Hòa", "Trần Việt Hưng", "Trần Văn Tuấn", "Nguyễn Ngọc Quý", "Duy Phạm", "Phạm Tiến Hùng"] },
