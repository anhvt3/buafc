...
const INITIAL_MATCHES = [
  ...
  { date: "2026-07-14", opponent: "Nội bộ", result: "Thua", cost: 0, note: "", losingTeam: ["Nguyễn Viết Hòa", "Trần Văn Tuấn", "Hùng Chu", "Trịnh Minh Châm", "Phạm Tiến Hùng"], playedTeam: ["Thai Nguyen", "Nguyễn Minh", "Nguyễn Viết Hòa", "Trần Văn Tuấn", "Hùng Chu", "Trịnh Minh Châm", "Phạm Tiến Hùng", "Vũ Thế Anh", "Nguyễn Khắc Dũng", "Quyền Ruốc", "Duy Dương", "Trần Đức", "Vũ Văn An"] }
];
