const DATA_VERSION = "buafc-2026-07-16-v2";
...
const INITIAL_MATCHES = [
  ...
  { date: "2026-07-07", opponent: "Nội bộ", result: "Thua", cost: 0, note: "", losingTeam: ["Thai Nguyen", "Đoàn Thế Anh", "Nguyễn Minh", "Nguyễn Khắc Dũng", "Trần Việt Hưng", "Trần Văn Tuấn", "Vũ Văn An"], playedTeam: ["Thai Nguyen", "Đoàn Thế Anh", "Nguyễn Minh", "Nguyễn Khắc Dũng", "Trần Việt Hưng", "Trần Văn Tuấn", "Vũ Văn An", "Vũ Thế Anh", "Tien Pham Duy", "Nguyễn Ngọc Quý", "Phạm Tiến Hùng", "Phú Hà", "Trịnh Minh Châm", "Nguyễn Viết Hòa", "Duy Phạm"] }
];
